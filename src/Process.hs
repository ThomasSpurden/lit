...
, mdPipeline
, codePipeline ) where
{-# LINE 28 "Process.hs.lit" #-}
import Prelude hiding (readFile, writeFile)
import Data.Text.IO (writeFile, readFile)
import System.FilePath.Posix (takeFileName, takeExtension, dropExtension, combine)
...
{-# LINE 80 "Process.hs.lit" #-}
{-# LINE 86 "Process.hs.lit" #-}
